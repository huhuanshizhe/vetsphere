  ...
  if (user.role === 'Doctor') {
     ...
     return (
        ...
        >
                         ...
                         <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm flex flex-col md:flex-row items-center gap-10">
                             ...
                             <div className="flex-1 text-center md:text-left">
                                 ...
                                 <div className="grid grid-cols-3 gap-8 border-t border-slate-50 pt-6">
                                     <div><p className="text-xs font-black text-slate-400 uppercase mb-1">Enrolled</p><p className="text-xl font-black">{enrollments.length}</p></div>
                                     <div><p className="text-xs font-black text-slate-400 uppercase mb-1">Completed</p><p className="text-xl font-black">{completedCourses}</p></div>
                                     <div><p className="text-xs font-black text-vs uppercase mb-1">Points</p><p className="text-xl font-black text-vs">{userPoints}</p></div>
                                 </div>
                             </div>
                         </div>
                         ...
                         {enrollments.length > 0 && (
                           <div className="bg-white p-8 rounded-[32px] border border-slate-100">
                             <div className="flex justify-between items-center mb-6">
                               ...
                               <button onClick={() => setActiveTab('My Courses')} className="text-vs text-xs font-bold hover:underline">View All →</button>
                             </div>
               ...
               <div className="space-y-6">
                 ...
                 {loading ? (
                   ...
                   <div className="bg-white p-12 rounded-[32px] border border-slate-100 text-center">
                     ...
                     <button onClick={() => router.push('/courses')} className="bg-vs text-white px-6 py-3 rounded-xl font-bold text-sm">
                       Browse Courses
                     </button>
                   </div>
                 ) : (
             ...
             {activeTab === 'My Orders' && (
               <div className="space-y-6">
                 <h3 className="font-black text-xl text-slate-900">Order History</h3>
                 {orders.length === 0 ? (
                   <div className="bg-white p-12 rounded-[32px] border border-slate-100 text-center">
             ...
             {activeTab === 'Rewards Hub' && (
               <div className="bg-white p-10 rounded-[32px] border border-slate-100">
                 <h3 className="font-black text-xl text-slate-900 mb-6">Points & Rewards</h3>
                            ...
                            <div className="flex flex-col gap-6 overflow-y-auto pr-2 custom-scrollbar">
                                ...
                                <div className="p-6 border rounded-2xl border-slate-100 bg-white">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <label className="block text-xs font-black text-slate-400 uppercase mb-1">Price (CNY)</label>
