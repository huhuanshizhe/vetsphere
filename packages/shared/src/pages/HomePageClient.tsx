          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link href="/courses" className="px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold text-base hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                  {t.home.ctaCourse}
                </Link>
                <Link href="/shop" className="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-2xl font-bold text-base hover:bg-slate-50 transition-all flex items-center gap-2">
        ...
        <div className="vs-container relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-8 mb-8">
             ...
             <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 to-blue-900 rounded-3xl p-10 text-white relative overflow-hidden group hover:shadow-2xl transition-all duration-500 flex flex-col justify-between min-h-[320px]">
                ...
                <div>
                    <div className="inline-block px-3 py-1 bg-white/10 rounded-lg text-[10px] font-black uppercase tracking-widest mb-4 border border-white/20">{isCN ? '战略合作伙伴' : 'Strategic Partner'}</div>
          ...
          <div className="mt-12 flex justify-center">
             <div className="inline-flex items-center gap-3 px-6 py-3 bg-slate-900 rounded-full text-white text-xs font-bold shadow-lg">
                ...
                {isCN ? '讲师团均为来自这些顶尖院校的 ACVS / ECVS 专科认证医师' : 'Faculty are Board-Certified Diplomates (ACVS / ECVS) from these institutions.'}
             </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="vs-container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div 
              onClick={() => router.push(`/courses?specialty=${Specialty.ORTHOPEDICS}`)}
            ...
            <div 
              onClick={() => router.push(`/courses?specialty=${Specialty.NEUROSURGERY}`)}
              className="group cursor-pointer rounded-2xl border border-slate-200 overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 bg-slate-50"
            >
              <div className="h-64 overflow-hidden relative">
            ...
            <div 
              onClick={() => router.push(`/courses?specialty=${Specialty.SOFT_TISSUE}`)}
              className="group cursor-pointer rounded-2xl border border-slate-200 overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500 bg-slate-50"
            >
              <div className="h-64 overflow-hidden relative">
        ...
        <div className="vs-container relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="pt-8">
                <Link href="/shop" className="px-8 py-4 bg-white text-slate-900 rounded-2xl font-bold text-base hover:bg-emerald-50 transition-all inline-block">
                  {t.home.equipCta}
                </Link>
              </div>
            </div>
