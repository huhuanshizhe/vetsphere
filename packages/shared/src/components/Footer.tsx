      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="pt-6">
            ...
            <div className="flex gap-2 max-w-xs">
              <input
                type="email"
                placeholder={isCN ? '邮箱地址' : (language === 'zh' ? '邮箱地址' : 'Email address')}
        ...
        <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8 lg:pl-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-500">
              <li><Link href={localePath('/faq')} className="hover:text-emerald-400 transition-colors">{isCN ? '常见问题' : (language === 'zh' ? '常见问题' : 'FAQ')}</Link></li>
